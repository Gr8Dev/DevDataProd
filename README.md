...
1.Clone the code using 'git clone https://github.com/Gr8Dev/DevDataProd.git YOURDIRECTORY'
...
Apps location
The application is deployed on ShinyApps.io at http://suemo123.shinyapps.io/myapp
